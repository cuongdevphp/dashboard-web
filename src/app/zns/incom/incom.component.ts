...
export class IncomComponent implements OnInit {
    ...
    //         setTimeout(function () {
    //             window.open(`http://localhost:3001/assets/excel/${result.result}`);
    //         }, 1000);
    //         // if(result.successList.length > 0) {
    //         //     this.notification.create(
    //         //         'success',
    ...
    uploadFile(info: NzUploadFile, sendMultipleMessageContent: TemplateRef<{}>): void {
        ...
        // if(info.type === 'progress') {
            ...
            reader.onload = (e) => {
                ...
                // const firstSheetName = workbook.SheetNames[0];
                // const worksheet = workbook.Sheets[firstSheetName];
                // const list_params: any = XLSX.utils.sheet_to_json(worksheet, { raw: true });
                // console.log('Excel data:', list_params);
